...
export function DemoControlConsole() {
  ...
  return <main className={styles.shell}>
    ...
    <dialog className={styles.dialog} ref={reportDialog} aria-labelledby="demo-report-title"><form onSubmit={addIncident}><h2 id="demo-report-title">Report demo incident</h2><label>Severity<select name="severity" defaultValue="moderate"><option value="low">Low</option><option value="moderate">Moderate</option><option value="high">High</option></select></label><label>Location<input name="location" required maxLength={160} placeholder="e.g. North Gate" /></label><DialogActions onCancel={() => reportDialog.current?.close()} confirm="Add local demo incident" /></form></dialog>
