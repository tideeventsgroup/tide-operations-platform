...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  try {
    const command = createIncidentCommand({
      ...
      immediateAssistanceRequired: body.immediateAssistanceRequired,
    ...
    const { data, error } = await client.rpc("create_incident_report", {
      ...
      p_immediate_assistance_required: command.immediateAssistanceRequired,
      ...
      p_subcategory_id: command.subcategoryId,
